...
final getLoveLanguageConceptsProvider = Provider<GetLoveLanguageConcepts>((ref) {
  return GetIt.I<GetLoveLanguageConcepts>();
});

class GetLoveLanguageConcepts implements UseCase<LocalizationContent, NoParams> {
  final PreloadDataRepository repository;

  const GetLoveLanguageConcepts({required this.repository});

  @override
  Future<Either<Failure, LocalizationContent>> call(NoParams params) async {
    return await repository.getLoveLanguagesConcepts();
  }
}
