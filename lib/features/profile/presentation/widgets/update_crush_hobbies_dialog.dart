...
class UpdateCrushHobbiesDialog extends ConsumerStatefulWidget {
  const UpdateCrushHobbiesDialog({super.key});

  @override
  ConsumerState<UpdateCrushHobbiesDialog> createState() => _UpdateCrushHobbiesDialogState();
}

class _UpdateCrushHobbiesDialogState extends ConsumerState<UpdateCrushHobbiesDialog> {
  ...
  Widget build(
    ...
    final hobbies = ref.watch(profileNotifierProvider).tempUserInfo?.crushInfo?.hobbies ?? [];
