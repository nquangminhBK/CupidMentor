...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/dark_light_mode.json
  LottieGenImage get darkLightMode => const LottieGenImage('assets/lottie/dark_light_mode.json');

  /// List of all assets
  List<LottieGenImage> get values => [darkLightMode];
}
...
class $AssetsPngGen {
  ...
  /// File path: assets/png/conflict_image.png
